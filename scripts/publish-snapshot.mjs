...
const bannedFile=/(?:^|\/)(?:node_modules|\.git|\.next[^/]*|build|__pycache__|\.gradle|test-results|playwright-report)\/|(?:\.db(?:-wal|-shm|-journal)?|\.keystore|\.jks|\.pem|\.key|\.mp3|\.m4a|\.wav|\.webm|\.ogg|\.opus|\.mp4|\.rdbackup|\.bak|\.part|\.docx|\.pdf|\.gz|\.zip|\.pyc|\.log|\.tsbuildinfo)$|(?:^|\/)local\.properties$/i;
