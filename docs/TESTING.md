...
- V2新学/复习中文先行、揭晓后三档自评；首见diagnostic_exposure初始化日级FSRS但review_count=0；正式复习计数+1。旧24h due不回算。
...
按本轮风险执行必要独立Review，不为小改强制多轮全库；真实材料、真实语音、视觉、效果分开留证。CI完整门保留，未执行的检查明确说明，仅代码通过不宣布提效。
