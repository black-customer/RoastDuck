...
export const VOICE_PRESETS: VoicePresetConfig[] = [
  ...
  { id: "us-male", label: "美音男声 (Dean)", sublabel: "美式沉稳温和", mimoVoice: "Dean", accent: "en-US", gender: "male" },
  { id: "uk-female", label: "英音女声 (Mia)", sublabel: "英式优雅清脆", mimoVoice: "Mia", accent: "en-GB", gender: "female" },
  { id: "uk-male", label: "英音男声 (Milo)", sublabel: "英式绅士自然", mimoVoice: "Milo", accent: "en-GB", gender: "male" },
];
